    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_EntityGraph_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_EntityGraph_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");
...
//              jpa_core_EntityGraph_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
        ...
        // Ear
            ...
            jpa_core_EntityGraph_vehicles_ear.addAsModule(jpa_core_EntityGraph_appmanaged_vehicle_ejb);
            jpa_core_EntityGraph_vehicles_ear.addAsModule(jpa_core_EntityGraph_appmanaged_vehicle_client);
